...
fn builds_voicegenie_asr_session_payload_with_web_asr_config() {
    ...
    assert!(payload.contains(r#""max_vad_accumulate_duration_ms":1800000"#));
    assert!(payload.contains(r#""reset_voice_max_seconds":1800"#));
    assert!(payload.contains(r#""voice_max_seconds":1800"#));
